...
test_hm_ha:			test_hm_ha.o hm_pair.o	hm_hash.o hm_vector.o
	$(LINK) test_hm_ha	test_hm_ha.o hm_pair.o	hm_hash.o hm_vector.o				$(LIBS)

test_hm_ha.o: test_hm.c		hm_pair.h hm_list.h test_hm_factory.h		hm_hash.h hm_vector.h
...
hm_linklist.o: hm_linklist.c hm_linklist.h hm_list.h
	$(CC) hm_linklist.c
