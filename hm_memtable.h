...
const hm_pair_t *hm_memtable_it_first(const hm_memtable_t *l, const void **it);
const hm_pair_t *hm_memtable_it_next(const hm_memtable_t *l,  const void **it);
